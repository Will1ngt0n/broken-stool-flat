  ...
  
          {
            ...
            table: {
              ...
              body: [
                ...
                [{text: 'Subtotal:'}, {text: 'R'}, {text: this.totalPrice}],
                [{text: 'Delivery fee:'}, {text: 'R'}, {text: this.deliveryFee}],
                [{ text: 'TOTAL', bold: true, color: 'gray', lineHeight: 2, marginTop: 10, },
                { text: 'R', bold: true, color: 'gray', lineHeight: 2, marginTop: 10 },
                { text: this.grandTotal, bold: true, color: 'gray', lineHeight: 2, marginTop: 10 },]
              ]
            }
